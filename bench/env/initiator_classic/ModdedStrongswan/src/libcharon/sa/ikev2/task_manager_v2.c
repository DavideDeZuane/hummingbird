...
struct timespec start, end;
    ...
    DBG1(DBG_IKE, "Elapsed CPU time for initiate: %.6f seconds\n", elapsed);
	return retransmit(this, this->initiating.mid);
}
...
-DAVIDE
à#####################################################
questa funzione viene chiamata nel metodo 
#######################################################
*/
/**
...
-DAVIDE
##################################################
Assegniamo al metodo process_message del manager questa funzione
quindi ogni volta che viene processato un messaggio si passa per di qua
##################################################
*/
	...
	private_task_manager_t *this, message_t *msg)
{
	...
	*/
    ...
    DBG1(DBG_IKE, "Elapsed CPU time for processing message: %.6f seconds", elapsed);
	return SUCCESS;
}
