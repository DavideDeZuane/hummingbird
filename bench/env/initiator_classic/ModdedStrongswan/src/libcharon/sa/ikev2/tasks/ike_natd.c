	...
	private_ike_natd_t *this, message_t *message)
{
    ...
    DBG1(DBG_IKE, "ike_natd.c - Elapsed CPU time for building natd src: %.6f seconds", elapsed);
	...
	private_ike_natd_t *this, message_t *message)
{
    ...
    double elapsed = (end.tv_sec - start.tv_sec) + 
                     (end.tv_nsec - start.tv_nsec) / 1e9;
    DBG1(DBG_IKE, "ike_natd.c - Elapsed CPU time for building natd dst: %.6f seconds", elapsed);
	return SUCCESS;
}
